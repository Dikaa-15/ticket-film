...
<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
  <h2 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Studio</h2>

  <form action="{{ route('studio.store') }}" method="POST" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
    @csrf
