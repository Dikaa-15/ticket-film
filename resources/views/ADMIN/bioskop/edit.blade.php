...
@section('content')
  <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Edit Bioskop</h2>

    <form action="{{ route('bioskop.update', $bioskop->id) }}" method="POST" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
      @csrf
      @method('PUT')
      ...
      <div>
        ...
        <input
          ...
          id="address"
          name="address"
          value="{{ old('address', $bioskop->address) }}"
      ...
      <div>
        ...
        <input
          ...
          id="contact"
          name="contact"
          value="{{ old('contact', $bioskop->contact) }}"
