...
@section('content')
<h1 class="text-xl mb-3 text-gray-900 font-bold">Show Times</h1>
    ...
    <table class="min-w-full divide-y divide-gray-200 text-sm">
        <thead class="bg-gray-50 text-left font-medium text-gray-700">
            <tr>
                ...
                <th class="px-4 py-3">Berakhir Tayang</th>
        ...
        <tbody class="divide-y divide-gray-100 bg-white">
            ...
            <tr class="hover:bg-gray-50 transition-all">
                <td class="px-4 py-3 font-medium text-gray-900">{{ $showtime->film->title }}</td>
                <td class="px-4 py-3 text-gray-700">{{ $showtime->studio->name }}</td>
                <td class="px-4 py-3 text-gray-700">{{ \Carbon\Carbon::parse($showtime->show_date)->format('F j, Y') }}</td>
                <td class="px-4 py-3 text-gray-700">{{ $showtime->show_time }}</td>
                <td class="px-4 py-3 text-gray-700">{{ $showtime->end_time }}</td>
                <td class="px-4 py-3 text-gray-700">{{ number_format($showtime->price, 0, ',', '.') }}</td>
                <td class="px-4 py-3">
